 ...
 * System.out.println(radius);//this is proof that operations made from a print
 * statement stays only in that line
 * System.out.println((--radius));//this is proof that increment/decrement &
 * augmented assignment operators affect also the following lines
 ...
 * System.out.
 * print("In that case, do you want to remove your whole history(1) or remove a specific one(2)? "
 * );
