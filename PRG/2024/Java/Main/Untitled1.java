public class Untitled1 {
    public static void main(String[] args) {
        ...
        // primitive - Static values, meaning static data types has a limit to their
        // memory allocation
        ...
        char h;// 2 bytes = single character
               // reference - Dynamic values, meaning reference data types don't have a limit
               // to their memory allocation. They store
               // addresses like arrays in C rather than data in primitives but they're slower
               // than primitives
        // characters
         ...
         * There are two types of type casting: Primitive and Reference, and those have
         * two types also
         ...
         *
         * Primitive :
         * Widening type cast(implicit / automatic) - There is no data lost as we
         * convert the data type into lowest to biggest
         * byte -> short -> int -> long -> float -> double
         * int age = 10;
         * float height = age+0.1f;
         * long temp;
         * System.out.print((temp = height)); You can actually perform this also in
         * print statements
         *
         *
         * Narrowing type cast(explicit / manual) - There is data lost as we are
         * essentially removing a data by converting
         * them into smaller data types
         * double -> float -> long -> int -> short -> byte
         * double age = 10.5;
         * int _age = (int)age;
         * byte __age;
         * System.out.println((__age = (byte)_age)); You can actually perform this also
         * in print statements
         *
         * -----------------------------------------------------------------------------
         * -----------------
         ...
         * ---------------------------- Literal and Object
         * ----------------------------------------------
         * This is useful in type casting so you can specify if something will be an
         * index or a direct value.
        ...
        // in this print statement, I assigned a value to d in which it didn't have a
        // value before. For this concept, by applying two parenthesis
        // into the variable after the sign '+', we can form operations/expressions in
        // there
         ...
         * In declaring a library in Java we start by the import function, and then the
         * name of the library(i.e math), the package name
        ...
        // USER INPUT
        /*
         * The user input in Java is different in C language, in that there are many
         * thigns to do and you need to initialize your scan function
         * User inputs all have their own built in newline and they detect that newline
         * as the end of the user input, but some don't detect it
         * and causes an input buffer for inputting that newline into the next scanner
         * 
         * in initializing the user input in java, we need to have the library and
         * initialize the function
         * 
         * Syntax:
         * libr = import.util.Scanner
         * main_func = Scanner scanner_name = new Scanner(System.in); (THIS IS CALLED
         * OBJECT)
         * -- to call this function and have user input --
         * scanner_name.next_(type of user input)();
         * -- Method -- There are specifically made inputs in these scanners. So if a
         * variable is int, you input int.
         * scanner_name.nextLine(); - strings(reads newline and accepts as end),
         * includes whitespace(reads it)
         * scanner_name.next() - strings(reads newline and accepts as end), stops at
         * whitespace(doesnt't read it)
         * scanner_name.next().charAt(index) - char, get a single character out of a
         * string
         * scanner_name.nextInt(); - integers(doesn't read newline so it acts like %c in
         * C lang so you'll have input buffer)
         * scanner_name.close(); - closes the scanner
         * -- in assigning a value to a dynamic variable --
         * variable_name = scanner_name.next_type();
         * -- in just referencing the scanner for prevent input buffer or just to have a
         * user input --
         ...
         * expression - the mixture of operands and operation, although it does not have
         * a result
         */
        // ---------------------------------------------------------------------------------------------------------------------------------------------
        // GUI, Graphical User Interface
        /*
         * In order to create a gui, we need the library JOptionPane, and it includes
         * input dialog boxes, display dialogue
         * boxes, and many more. However, there are specifically made dialogue boxes for
         * different inputs. And the
         * showInputDialogue returns only strings. And so we can use the parse method.
         * 
         * Keywords:
         * parentcomponent: This sets up the coordinate of the said component or dialog
         * box
         ...
         * function syntax:
         * JOptionPane.showInputDialog(message); - this lets the user input something.
         * You need to have a placeholder for this, although you can
         * run it without
         * JOptionPane.showMessageDialog(parent_component, message); - this lets you
         * output your messages. You don't need a placeholder for this
         * JOptionPane.showConfirmDialog(parent_component, message); - this lets you
         * pick between yes, no, and cancel. Yes = 0, no = 1, cancel = 2.
         * This returns an integer so you should have an int placeholder.
         * JOptionPane.showOptionDialog(parent_componet, - This lets you have options
         * through your array. Same as confirm dialog
         * message, but with a lot of optiond
         * title, - Title of the GUI
         * (int)optionType - Types of option: [yes_no(0), yes_no_cancel(1),
         * ok_cancel(2)]
         * (int)messageType - Types of message icon [error(0), information(1),
         * warning(2), question(3), plain(4)]
         * Icon - (I don't know yet)
         * ptions - Options from the arrayO
         * initialValue - Standard option from the array to be chosen if user presses
         * <enter>
         * )
         * -----Return----
         * The return of this functions are actually simple. From the most left, it
         * starts
         * at zero, and then to the most right as the last point. In which we can treat
         * t-
         ...
         * "Welcome, "+full_n+", and your age is "+age+".");
         * }
         * }
         * 
         * ----------- Confirm Dialog ----------------
        ...
        /*
         * MATH FUNCTIONS
         * Java has practically the same math functions just like c, however you don't
         * need a library for this
         *
         * Math is a reference type function so we have to capitalize and then the dot
         ...
         * ...
         *
         * Also, when we have division in our variables, be sure to typecast them or
         * include a decimal(can be .0) because the operands are integers.
         *
         *
         *
         *
        ...
        /*
         * RANDOM NUMBERS
         * Random numbers in java are dissimilar to C, in which it has an autonomous
         * srand function with built in time function that
         * will change upon null. Think of it as a combined srand and rand.
         *
         * Library : import java.util.Random
         * After importing the library, we need to create a name for the instance of the
         * random class, think of it as the same
         ...
         * int random2 = rand.nextInt(10)+1;//With a limiter value of 10(this sets the
         * limit of the random, kinda
         * //like the modulus in C that sets the limit. And we also have + 1 because
         * computers start at zero);
        ...
        // -----------------------------------------CONTROL
        // STRUCTURES------------------------------------------------------------------------------
        // Sequential - Pertains to the order of execution of code, from top to bottom,
        // and code precedence(code that is executed first)
        // ---------------------------------------------------------------------------------------------------------------------------------------------
        /*
         ...
         * *note : in the operator '=', this is an assignment operator used to assign
         * values; while "=="
         ...
         * ! NOT operator : Makes a comparison/relational operator opposite (e.g true ==
         * false). Reverses the boolean value
         *
         * if | else if | else statements
         * 
         * The if, else if, else statements are the basic decision making statements.
         * Each of these statements scans if a given relational
         * operator or comparizon operator are true, and if true then the block of code
         * inside these statements are run. Each order of re-
         * lational operators are run from the top to the ground, and so placement of
         * these operators matter.
         *
         * Switch Statement
         *
         * The switch statement tests the equality of a given variable to a certain
         * value. It uses cases instead of if else, and default
         *
         * Allowed :
         ...
         * Loops are repetitive block of codes that is executed with a conditional or
         ...
         * }
         * 
         * While Loop - The block of code is iterated if the given condition is still
         * true, otherwise it will stop.
         * syntax : while(condition){block of code};
         * 
         * Do While Loop - the block of code is iterated first without being evaluated,
         * and then runs again for evaluation
         * if the condition is still true.
         * syntax : do{block of code}while(condition);
         * 
         * 
         * NESTED LOOP - Control Structure
         * Used for x and y, column and row, and many more. It has the same syntax as in
         * C.
         * 
         * 
         * 
         ...
         * This is an initialization done by having the "new" to create a reference to
         * an object inside a class. This has three ways
         * 
         ...
         * 
         * 
         * ------------- Class & Object & Method & Members & Field & Access Modifiers &
         * Packages & Libraries --------------
         * Class - A class is a blueprint or template for an object to be initialized.
         * It contains field and methods. They are very
         * similar to structs, but structs can only contain variables.
         * i.e. public class name{field, method}
         * 
         * Object - An entity that is made from the definitions of a class. It is the
         * class object initialization, instance of a class,
         * and object instantiation.
         * i.e. name object_name = new name();
         * 
         * Method - A method is a function inside the class that manipulates or control
         * the object of that class. You cannot initialize
         * a function outside of the main function anymore, but you can initialize it
         * within a class or within the main class.
         * i.e public class name{field, static void
         ...
         * 
         * Package-private - This is also called default access, wherein the class is
         * accessible only within that package
         * 
         * Libraries - A list of packages
         * 
         * Constructor - Acts just like a function's argument, but with classes. You can
         * input and assign values inside the
         * members of that classes by instances
         * 
         * 
         * -- Access Modifiers
         * 
         * Public - Makes the class, method, variables, accessible everywhere. However,
         * public classes without static needs to have an object
         * for one to access its methods and fields - these are called instances.
         * Private - Makes the class, method, variables, accessible only inside that
         * class.
         * Static - Makes the class, method, variables accessible only to that class.
         * For example, if you have a public static class, then
         * the members of that class can only be accessed with that class with a dot
         * operator, rather than accessing its members
         * with an object. Also, if you have an array of classes and have static members
         * or specifically fields, then those fields
         * are shared among every array of objects and not unique. They are like
         * pointers.
         * Protected - Makes its member accessible to the same package and that
         * package's subclass or subpackages
         * Package-private - Makes the members accessible to the same package but not
         * outside and subclasses.
         * 
         * In summary with:
         * public void (members) requires an object to be accessed | access is anywhere
         * but only with an object (needs instances)
         * public static void (members) does not require an object to be accessed |
         * Access is anywhere
         * static void (members) access is only within the package and not outside
         * protected (members) access is only within the package and not outside (needs
         * instances)
         * package-private(members) access is only within the same package
         * 
         * ------- IMPORTANT ----------
         * There are two ways to initialize a class and its members.
         * 1. Into another file and access them without an import statement if they're
         * in the same package
         * 2. To the file itself, and access them the same
         * 3. You can only have 1 public or package-private modifier in your file
         * (class{main function} or public class{main function})
         * 4. And unlike in structs, with classes you can actually assign values to
         * members!
         * 5. If a class, with public or public static, are outside of a package, import
         * that outside package but make sure that the
         * outside package has a package statement that determines it's a package
         * 6. Classes in general does not need to have an object. It will depend if an
         * object is needed when the class
         * requires to have it or if the class has members that require it. It all
         * depends at the class's members.
         * 
         * -------- Package Creation ----
         * 1. In creating a package, you must have a file that will act as the package.
         * 2. Each of your classes in that package must have the package statement
         * (package package_name)
         * 3. When importing packages, you must import the package name and the class
         * name (import package_name.class_name)
         * 4. It is possible to have nested packages (package
         * package_name.package.name...)
         * 
         * 
         * Nested Classes - nested classes are classes inside classes
         * And when it comes to instances, you will be required to use the dot operator
         * if you need to instance an object if the
         ...
         * ARRAY
         * 
         * Arrays are a collection of similar data types. This data types can hold a
         * value, although not more than one. Arrays are
         * limited in a way that they can't be memory allocated if they are run. And so
         * with that, once you initialize the memory
         * or how many elements it will hold, that is the limit. The initialization is
         * the same as in C, but the declaration is not.
         * 
         * Initialization : Way 1
         * syntax:
         * datatype[] array_name = {block of similar values};
         * datatype[][] array_name = {{block of similar values}, {block of similar
         * values}};
         * 
         ...
         * 
         * Array functions
         * There are actually a ton of useful array functions, although not limited to
         * the dot operator, in Java unlike in C.
         * With the dot operator, we can get the lenght of the array just as if we
         * sizeof/sizeof[0] in C. It gets the total
         * number of elements even if the array is not initialized.
         * syntax:
         * array_name.length - gets the total lenght or number of array in an array(if
         * 2d), otherwise it gets the total number of elements
         * array_name[index] - gets the total lenght or number of elements in an array
         * 
         * 2D Array or Multidimensional Array:
         * This is an array within an array, or a collection of array with similar data
         * types.
         * 
         * 
         * -----------------------------------------------------------------------------
         ...
         * String Methods
         * 
         * String methods manipulate and control the behaviours of string, and as string
         * is a reference data type it has a lot of
         * methods at its disposal.
         * syntax:
         * .lenght - this returns integers, this checks the lenght of the string or how
         * many characters it has
         * .equal - this returns true or false; checks if a string is equal to another
         * string or value
         * .equalsIgnoreCase - this returns true or false; same with the equal method
         * but ignores cases
         ...
         * 
         * Wrapper Class
         * A wrapper class is the conversion of primite data type to reference data type
         * like String. This is a way for primitive
         * data types to access some of the useful methods of the reference data types
         * like lenght, equals, and more. This is als
         * -o used in collection (arraylist). This is also used in parsing.
         * 
         * autoboxing - this is the automatic conversion of primitive to object wrapper
         * class based on the java compiler
         * unboxing - accessing the value of the wrapperclass; this is the automatic
         * conversion of wrapper class to prim
         * -itive data type.
         * 
         * A wrapper class is easy to do as they're pretty much the same with the
         * declaration of primitive data types.
         * although their differences lies between their naming. Declaring a wrapper
         * class requires the first letter t
         * -o be a capital and then the full name of the data type(i.e int = Integer),
         * just like in String.
         * 
         * syntax:
         * boolean -> Boolean
         ...
         * ArrayList
         * 
         * ArrayList is just like an array but it doesn't have a limit, like say a *
         * size, and is indefinite. It is a resizeable array. And as there is a
         ...
         * so, when referencing the fields of the class, we have to use the this
         * keyword.
         * The this keyword lets us access the class' fields so that we can assign
         * values
         ...
         * It is a more beneficial way to pass things as you won't have to declare
         * object
         * names anymore.
         * 
         * 
         ...
         * void funct() - concrete method (subclasses can use it w/o override)
         * 
         * You can also initialize variables in this.
         * 
         * 
         * -----------------------------------------------------------------------------
         * --
         ...
         * Interface
         * 
         * This is a template for classes and implementation on what the classes
         * should do. This is similar to inheritance wherein you can access the elements
         * but is not limited to only one superclass, and to abstract classes wherein
         * you must explicitly extend it or make it a superclass and to override its
         * functions, but you cannot declare variables in an interface while you can in
         * abstract. Also, based on Java's access control rules, any methods from the
         * interface is inherently public because the interface is public, and so
         * the override method must also be of the public class or greater.
         * 
         * Syntax:
