...
- Prompt user for log-in or sign-in - if log-in, prompt user for valid username and password - if sign-up, prompt user for non-existing username and password - If username or password is already existing, tell user user or password is already existing; prompt again for non-existing username and password
<hr>
...
- Display enemy and self's health bar - Compare enemy and self's level - if enemy's level is greater than self, enemy attacks first - randomize enemy pattern: attack, defend - otherwise, self will attack first - self will choose: attack, defend
<hr>
...
class dungeon:
    ...
    def __init__(self):
        ...
        self.act_2 = ["You woken up with chills down your spine.", "Your legs feels as though they were metal...", "You are finding the courage to life yourself.", "You stood up, wondering why the dragon spared you while wandering to the cave.", "You see a shadow from the background... It was a skeleton!"]
